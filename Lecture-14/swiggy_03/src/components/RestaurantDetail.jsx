...
function RestaurantDetail() {
    ...
    useEffect(()=>{
        ...
        async function calling(){
            ...
            // console.log(resp.data.data.cards[5].groupedCard.cardGroupMap.REGULAR.cards[4].card.card.itemCards);    
            setFoodItemDetails(resp.data.data.cards[5].groupedCard.cardGroupMap.REGULAR.cards[4].card.card.itemCards);    
        }
        calling()
    },[id])
